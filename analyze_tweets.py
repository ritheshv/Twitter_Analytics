...
def main():
	...
	tweets_data = []
	tweets_file = codecs.open(tweets_data_path, "r","utf-16")
	...
	tweets['country'] = map(lambda tweet: tweet['place']['country'] if tweet.get('place',None) != None else None, tweets_data)
